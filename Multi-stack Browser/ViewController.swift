...
class ViewController: NSViewController, WKNavigationDelegate, NSGestureRecognizerDelegate, NSTouchBarDelegate, NSSharingServicePickerTouchBarItemDelegate {
    ...
    override func makeTouchBar() -> NSTouchBar? {
        ...
        touchBar.customizationIdentifier = NSTouchBar.CustomizationIdentifier("com.bitigchi.Multi-stack-Browser")
...
extension NSTouchBarItem.Identifier {
    static let navigation = NSTouchBarItem.Identifier("com.bitigchi.Multi-stack-Browser.navigation")
    static let enterAddress = NSTouchBarItem.Identifier("com.bitigchi.Multi-stack-Browser.enterAddress")
    static let sharingPicker = NSTouchBarItem.Identifier("com.bitigchi.Multi-stack-Browser.sharingPicker")
    static let adjustGrid = NSTouchBarItem.Identifier("com.bitigchi.Multi-stack-Browser.adjustGrid")
    static let adjustRows = NSTouchBarItem.Identifier("com.bitigchi.Multi-stack-Browser.adjustRows")
    static let adjustColumns = NSTouchBarItem.Identifier("com.bitigchi.Multi-stack-Browser.adjustColumns")
}
